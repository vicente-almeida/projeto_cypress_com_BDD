Feature: Login de Usuario
    ...
    Scenario: Login usuario valido
        ...
        When  preenchi os dados de login com usuario valido
        Then o sistema realiza meu login com sucesso me autenticando na pagina

    Scenario: Login com usuario valido e senha incorreta

        Given clico no botao de signin
        When  preenchi o campo email com um usuario valido
    ...
    Scenario: Login com email invalido e senha correta
        ...
        Given clico no botao de signin
        When preenchi o campo email com um usuario invalido
    ...
    Scenario: Login com email nao cadastraddo e senha correta
        ...
        Given clico no botao de signin
        When preenchi os campos de login com um usuario nao cadastrado
    ...
    Scenario: Login sem informar email
        ...
        Given clico no botao de signin
        When  preenchi os campos de login sem informar email
        And clico para realizar o login
    ...
    Scenario: Login sem informar senha
        ...
        Given clico no botao de signin
        When  preenchi os campos de login sem informar senha
        And   clico para realizar o login
